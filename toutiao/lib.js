!function(e, t) {
    ...
    function a(e, n, r) {
        ...
        function s() {
            d.parent && x && f(Object.keys(d.parent), function(e) {
                var t = !~$.indexOf(e) && ~F.indexOf(e);
                (typeof d[e] === L || t) && (t || F.push(e),
                d[e] = d.parent[e])
            })
        }
        function c(e) {
    ...
    N.mount = function(e, t, n) {
        ...
        function i(e) {
            var r;
            if (e.tagName) {
                !t || (r = e.getAttribute(F)) && r == t || e.setAttribute(F, t);
        ...
        if (typeof t === H && (n = t,
        t = 0),
        typeof e === I ? ("*" === e ? e = a = o() : e += r(e.split(",")),
        u = j(e)) : u = e,
        "*" === t) {
            if (t = a || o(),
            u.tagName)
...
!function(e, t) {
    ...
    var I, H, L, P, B, $ = e.Raven, D = !("object" != typeof JSON || !JSON.stringify), U = "undefined" != typeof document, z = {}, W = {
        logger: "javascript",
        ignoreErrors: [],
        ignoreUrls: [],
        whitelistUrls: [],
