    ...
    function (e, t, n) {
        ...
        ! function (e, t) {
            ...
            var n, r, i, o = e,
                ...
                fe = function (e) {
                    if (e && 1 === e.nodeType) {
                        r && (qe(r, K.activeClass), r !== e && qe(r, K.hoverClass)), r = e, Ie(e, K.hoverClass);
                ...
                we = function (e) {
                    var t = null;
                    return (!1 === H || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1), t
                },
                Te = function (e) {
                    ...
                    switch (delete e._source, e.type) {
                        ...
                        case "_mouseout":
                            ...
                            break;
                        case "_mousedown":
                            Ie(t, K.activeClass), !0 === K.bubbleEvents && o && Ce(S({}, e, {
                                type: e.type.slice(1)
                            }));
                            break;
                        case "_mouseup":
        ...
        t.init = function () {
            if (s.find(".dialog-alert--close").on("click", function () {
                    ...
                    i(), o(), p.clog("LOGIN_CLICK", ""), l.show(), c.show(), (y = new URS(b)).logincb = function (e, t, n) {
                        l.hide(), c.hide(), window.location.reload()
                    }, y.regcb = function (e) {}
        ...
        return function (e, t) {
            ...
            function d(e, t) {
                if (1 === t.nodeType && M.hasData(e)) {
                    ...
                    if (s) {
                        ...
                        for (n in s)
                            for (r = 0, i = s[n].length; r < i; r++) M.event.add(t, n + (s[n][r].namespace ? "." : "") + s[n][r].namespace, s[n][r], s[n][r].data)
                    }
            ...
            M.fn.extend({
                ...
                toggleClass: function (e, t) {
                    ...
                    return M.isFunction(e) ? this.each(function (n) {
                        ...
                        if ("string" === n)
                            for (var i, o = 0, a = M(this), s = t, l = e.split($); i = l[o++];) a[(s = r ? s : !a.hasClass(i)) ? "addClass" : "removeClass"](i);
                ...
                removeAttr: function (e, t) {
                    var n, r, i, o, a = 0;
                    if (1 === e.nodeType)
                        for (o = (r = (t || "").split($)).length; a < o; a++) i = r[a].toLowerCase(), n = M.propFix[i] || i, M.attr(e, i, ""), e.removeAttribute(K ? i : n), Z.test(i) && n in e && (e[n] = !1)
                },
                attrHooks: {
                    type: {
                        set: function (e, t) {
            ...
            M.event = {
                    ...
                    remove: function (e, t, n, r) {
                        ...
                        if (m && (u = m.events)) {
                            for (t = oe(t || "").split(" "), i = 0; i < t.length; i++) {
                                ...
                                if (f = M.event.special[a] || {}, a = (r ? f.delegateType : f.bindType) || a, p = u[a] || [], l = p.length, s = s ? new RegExp("(^|\\.)" + s.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, n || s || r || f.remove)
                    ...
                    trigger: function (n, r, i, o) {
                        if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                            var a, s, l, c, u, f, d, p, h, m, g = n.type || n,
                                v = [];
                            if (g.indexOf("!") >= 0 && (g = g.slice(0, -1), s = !0), g.indexOf(".") >= 0 && (g = (v = g.split(".")).shift(), v.sort()), i && !M.event.customEvent[g] || M.event.global[g])
                                if (n = "object" == typeof n ? n[M.expando] ? n : new M.Event(g, n) : new M.Event(g), n.type = g, n.isTrigger = !0, n.exclusive = s, n.namespace = v.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, f = g.indexOf(":") < 0 ? "on" + g : "", !o && i || n.preventDefault(), i) {
                ...
                function () {
                    ...
                    var d = function (e, t, n, i) {
                        ...
                        if (c || (c = l), c || d.error(p || e), "[object Array]" === a.call(c))
                            if (b)
                                if (t && 1 === t.nodeType)
            ...
            M.fn.extend({
                find: function (e) {
                    ...
                    for (t = 0, n = this.length; t < n; t++)
                        if (i = s.length, M.find(e, this[t], s), t > 0)
            ...
            M.fn.css = function (e, n) {
                ...
                M.cssHooks[t] = {
                    get: function (e, n, r) {
                        var i;
                        if (n) return 0 !== e.offsetWidth ? y(e, t, r) : (M.swap(e, He, function () {
                            i = y(e, t, r)
                        }), i)
                    },
                    set: function (e, t) {
            ...
            Be = nt.exec(Pe.toLowerCase()) || [], M.fn.extend({
                ...
                ajax: function (e, n) {
                    function r(e, n, r, a) {
                        if (2 !== w) {
                            ...
                            if (e >= 200 && e < 300 || 304 === e)
                                if (d.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (M.lastModified[i] = b), (x = T.getResponseHeader("Etag")) && (M.etag[i] = x)), 304 === e) S = "notmodified", c = !0;
                                else try {
                    ...
                    var i, o, a, s, l, c, u, f, d = M.ajaxSetup({}, n),
                        p = d.context || d,
                                ...
                                l.send(n.hasContent && n.data || null), r = function (e, i) {
                                    ...
                                    try {
                                        if (r && (i || 4 === l.readyState))
                                            if (r = t, a && (l.onreadystatechange = M.noop, ut && delete ct[a]), i) 4 !== l.readyState && l.abort();
                                            else {
            ...
            M.fn.extend({
                ...
                animate: function (e, t, n, r) {
                    function i() {
                        ...
                        var t, n, r, i, a, s, l, c, u, f = M.extend({}, o),
                            d = 1 === this.nodeType,
                    ...
                    if (e || i >= s.duration + this.startTime) {
                        ...
                        if (o) {
                            if (null == s.overflow || M.support.shrinkWrapBlocks || M.each(["", "X", "Y"], function (e, t) {
                                ...
                                }), s.hide && M(a).hide(), s.hide || s.show)
                                for (t in s.animatedProperties) M.style(a, t, s.orig[t]), M.removeData(a, "fxshow" + t, !0), M.removeData(a, "toggle" + t, !0);
            ...
            "getBoundingClientRect" in O.documentElement ? M.fn.offset = function (e) {
                ...
                for (var n, r = t.offsetParent, i = t.ownerDocument, o = i.documentElement, a = i.body, s = i.defaultView, l = s ? s.getComputedStyle(t, null) : t.currentStyle, c = t.offsetTop, u = t.offsetLeft;
                    (t = t.parentNode) && t !== a && t !== o && (!M.support.fixedPosition || "fixed" !== l.position);) n = s ? s.getComputedStyle(t, null) : t.currentStyle, c -= t.scrollTop, u -= t.scrollLeft, t === r && (c += t.offsetTop, u += t.offsetLeft, !M.support.doesNotAddBorder || M.support.doesAddBorderForTableAndCells && xt.test(t.nodeName) || (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0), r, r = t.offsetParent), M.support.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (c += parseFloat(n.borderTopWidth) || 0, u += parseFloat(n.borderLeftWidth) || 0), l = n;
